...
#email: nil, encrypted_password: nil, confirmation_token: nil, remember_token: nil, name: nil, first_name: nil, last_name: nil, gender: nil, phone: nil, country: nil, birthday: nil
...
#name: nil, place_type: nil, property_type: nil, room_number: nil, bed_number: nil, guest_number: nil, country: nil, state: nil, city: nil, zipcode: nil, address: nil, price: nil, description: nil, user_id: nil, created_at: nil, updated_at: nil
